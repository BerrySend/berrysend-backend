...
# Create a synchronous database URL for Alembic
def get_alembic_database_url():
    """
    Creates a synchronous database URL for Alembic migrations.
    Converts the async aiomysql driver to synchronous pymysql.
    """
...
# Override sqlalchemy.url with the proper synchronous URL
